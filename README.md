...
Este repositório é dedicado exclusivamente à distribuição das versões compiladas (APKs) do aplicativo **Servir**.
...
---
*Este é um repositório de distribuição automatizado via GitHub Actions.*
